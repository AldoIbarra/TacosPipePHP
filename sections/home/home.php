                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 491.75 369.07">
                    ...
                    <g id="Layer_2" data-name="Layer 2">
                        <g id="Layer_1-2" data-name="Layer 1">
                            ...
                            <path class="gringa gringa-g" d="M400.18,26.29a116.89,116.89,0,0,0-22.44,3.31c-18.91,4.86-37.93,8.78-57.25,10.38,12.14,45.89,17.14,92.65,12.56,140.28l.47.23C352.05,166,378,153.58,401.34,162.26A228.21,228.21,0,0,0,400.18,26.29Z"/>
...
<section id="branches">
    <div class="container">
        ...
        <div class="row maps">
            <div class="col-xl-4 col-lg-4 col-md-12 map"> <!-- //Tacos pipe pino Suárez -->
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 map"> <!-- //Tacos Pipe Madero -->
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 map"> <!-- Tacos Pipe Talleres -->
